...
namespace Proyecto1
{
    public class Cubo
    {
        ...
        public void Dibujar()
        {
          ...
          // GL.Rotate(15, 1, 1, 1);
           frontRoof(primitiveType);
            backRoof(primitiveType);
        ...
        private void frontRoof(PrimitiveType primitiveType)
        {
            GL.Begin(primitiveType);
            //GL.Color4(Color.Aqua);
            GL.Color3(1, 0.0, 0.0);//rojo
            GL.Vertex3(origen.x + ancho, origen.y + alto, origen.z + profundidad);
            GL.Vertex3(origen.x + ancho, origen.y + alto + profundidad, origen.z);
        ...
        private void backRoof(PrimitiveType primitiveType)
        {
            GL.Begin(primitiveType);
            //GL.Color4(Color.Aqua);
            GL.Color3(1, 0.0, 0.0);//rojo
